 ...
 * </p>
 * <ul>
 *   <li>{@link org.nasdanika.models.enterprise.impl.ViewImpl#getRepresentations <em>Representations</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ViewImpl extends MinimalEObjectImpl.Container implements View {
	...
	protected EClass eStaticClass() {
		return EnterprisePackage.Literals.VIEW;
	}
	...
	public EList<Representation> getRepresentations() {
		return (EList<Representation>)eDynamicGet(EnterprisePackage.VIEW__REPRESENTATIONS, EnterprisePackage.Literals.VIEW__REPRESENTATIONS, true, true);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EnterprisePackage.VIEW__REPRESENTATIONS:
