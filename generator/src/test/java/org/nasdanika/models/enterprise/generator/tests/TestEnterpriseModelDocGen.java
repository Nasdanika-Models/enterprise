package org.nasdanika.models.enterprise.generator.tests;
 ...
 *
 */
public class TestEnterpriseModelDocGen {
	
	@Test
	public void testGenerateEnterpriseModelDoc() throws IOException, DiagnosticException {
		...
		EcoreNodeProcessorFactory ecoreNodeProcessorFactory = new EcoreNodeProcessorFactory(
				...
				diagnosticConsumer,
				ecoreGenEnterpriseProcessorFactory);
		
		File actionModelsDir = new File("target\\action-models\\");
		actionModelsDir.mkdirs();
		File output = new File(actionModelsDir, "enterprise.xmi");
		...
		String siteMapDomain = "https://enterprise.models.nasdanika.org";		
