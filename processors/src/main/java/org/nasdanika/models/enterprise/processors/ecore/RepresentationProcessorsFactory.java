...
public class RepresentationProcessorsFactory {
	...
	@EClassifierNodeProcessorFactory(
			...
			documentation = 
					...
					* Diagram, say, [family diagram](https://family.models.nasdanika.org/index.html) or [sample family diagram](https://nasdanika-demos.github.io/family-semantic-mapping/index.html)
					* Table
					* List
					* Chart/Graph
					* Text
